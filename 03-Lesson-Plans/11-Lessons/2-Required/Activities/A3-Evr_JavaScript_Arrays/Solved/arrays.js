...
let secondLetter = lettersArray[1];
...
let slicedArray1 = lettersArray.slice(1);
// Return the first three items of an array
let slicedArray2 = lettersArray.slice(0, 3);
// Return the second and third items of an array
let slicedArray3 = lettersArray.slice(1, 3);
...
// A JavaScript string
let soundOfMusic = "The hills are alive with the sound of music";
...
let soundArray = soundOfMusic.split(" ");
